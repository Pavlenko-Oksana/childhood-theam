<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php
                   echo do_shortcode('[contact-form-7 id="144" title="Форма отправить вопрос"]');
                ?>
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="<?php the_field('tell_first', 2) ?>"><?php the_field('tell_first', 2) ?></a>
                                    <a href="<?php the_field('tell_second', 2) ?>"><?php the_field('tell_second', 2) ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_url');?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address><?php the_field('adres_nav'); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
